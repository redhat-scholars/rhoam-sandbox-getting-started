...
Register for a Developer Sandbox Red Hat OpenShift API Management for  by clicking on the red button in the https://developers.redhat.com/developer-sandbox/activities/share-java--applications-openshift-api-management[Red Hat OpenShift API Management user activities page]
...
image::1 The OpenShift console.png[width=100%]
