...
At the moment, OpenShift Dedicated needs a Network Policy to be manually created to allow access from Red Hat OpenShift API Management. This will  soon be automated. But for the purpose of this workshop, you will need to add this manually if this doesn't already exist.
