...
Register for a Developer Sandbox Red Hat OpenShift API Management for  by clicking on the red button in the https://red.ht/rhoam-sandbox[Red Hat OpenShift API Management user activities page]
